...
Text {
    ...
    Rectangle {
        ...
        color: root.focus ? BoneroComponents.Style.titleBarButtonHoverColor : "transparent"
    }
    ...
    BoneroEffects.ColorTransition {
        ...
        targetObj: root
        duration: 750
        blackColor: root.themeTransitionBlackColor !== "" ? root.themeTransitionBlackColor : BoneroComponents.Style._b_defaultFontColor
        whiteColor: root.themeTransitionWhiteColor !== "" ? root.themeTransitionWhiteColor : BoneroComponents.Style._w_defaultFontColor
    }
