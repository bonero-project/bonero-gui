...
MenuItem {
    ...
    background: Rectangle {
        color: BoneroComponents.Style.buttonBackgroundColorDisabledHover
        opacity: 0
    ...
    contentItem: RowLayout {
        ...
        Text {
            ...
            color: BoneroComponents.Style.buttonTextColor
        ...
        Text {
            color: BoneroComponents.Style.blackTheme ? BoneroComponents.Style.buttonTextColor : BoneroComponents.Style.defaultFontColor
