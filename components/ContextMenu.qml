...
MouseArea {
    ...
    Menu {
        ...
        background: Rectangle {
            border.color: BoneroComponents.Style.buttonBackgroundColorDisabledHover
            border.width: 1
            radius: 2
            color: BoneroComponents.Style.blackTheme ? BoneroComponents.Style.buttonBackgroundColorDisabled : "#E5E5E5"
        }
        ...
        BoneroComponents.ContextMenuItem {
