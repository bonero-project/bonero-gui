...
function getApproximateBlockchainHeight(_date, _nettype){
    var boneroBirthTime = _nettype == "Mainnet" ? 1397818193 : _nettype == "Testnet" ? 1410295020 : 1518932025;
    var secondsPerBlockV1 = 60;
    var forkTime = 1739822746;
    // v2 fork block
    var forkBlock = 17158;
    ...
    var secondsPerBlock;
    // before bonero's birth
    if (requestedTime < boneroBirthTime){
        console.log("Calculated blockchain height: 0, requestedTime < boneroBirthTime " );
        return 0;
    }
    // time between during v1
    if (requestedTime > boneroBirthTime && requestedTime < forkTime){
        approxBlockchainHeight = 0
