...
ColumnLayout {
    ...
    RowLayout {
        ...
        BoneroComponents.Label {
            color: lineEdit.inputHasFocus ? BoneroComponents.Style.defaultFontColor : BoneroComponents.Style.dimmedFontColor
            fontSize: 13
            text: (wordNumber + 1)
        ...
        BoneroComponents.TextPlain {
            ...
            color: wordsMatch ? (BoneroComponents.Style.blackTheme ? "#00FF00" : "#008000") : "#FF0000"
            themeTransition: false
            onTextChanged: {
    ...
    Rectangle {
        id: underLine
        color: lineEdit.inputHasFocus ? BoneroComponents.Style.defaultFontColor : BoneroComponents.Style.appWindowBorderColor
